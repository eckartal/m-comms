...
export function CollabEmptyState({
    ...
    return (
      <div className="flex h-full items-center justify-center px-6">
        <div className="max-w-md w-full border border-[#262626] rounded-xl bg-[#050505] p-6 text-center">
          <div className="mx-auto mb-3 h-10 w-10 rounded-full bg-amber-950/40 flex items-center justify-center text-amber-400">
  ...
  if (variant === 'filtered') {
    return (
      <div className="flex h-full items-center justify-center px-6">
        <div className="max-w-md w-full border border-[#262626] rounded-xl bg-[#050505] p-6 text-center">
          <div className="mx-auto mb-3 h-10 w-10 rounded-full bg-[#111111] flex items-center justify-center text-muted-foreground">
            <FilterX className="h-5 w-5" />
          </div>
          <h2 className="text-base font-semibold text-foreground">No posts match this filter</h2>
