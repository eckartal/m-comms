    ...
    <div className="flex min-h-screen items-center justify-center bg-black p-4">
      <Card className="w-full max-w-sm border-[#262626]">
        <CardHeader className="pb-3">
          ...
          <CardDescription className="text-[11px] text-[#737373]">
            Sign in to continue
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-3">
          ...
          <form onSubmit={handleLogin} className="space-y-3">
            ...
            <div className="space-y-1">
              <div className="flex items-center justify-between">
                ...
                <Link href="/forgot-password" className="text-[10px] text-[#737373] hover:text-white">
                  Forgot?
                </Link>
              </div>
              <Input
          ...
          <div className="relative py-1">
            ...
            <div className="relative flex justify-center">
              <span className="bg-black px-2 text-[10px] text-[#525252]">or</span>
            </div>
          </div>

          <Button
            variant="outline"
            className="w-full h-7 border-[#262626] bg-transparent hover:bg-white/5"
          ...
          >
            <svg className="mr-1.5 h-3 w-3" viewBox="0 0 24 24">
              ...
              <path d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z" fill="#404040" />
            </svg>
